...
export const gridStyles: GridStyles = {
    nodeStyles: {
        ...
        hovered: {
            TRANSMISSION: { color: "rgb(40, 160, 230)", size: 18, border: "2px solid rgb(64, 64, 64)" },
            DISTRIBUTION: { color: "rgb(30, 220, 80)", size: 16, border: "2px solid rgb(64, 64, 64)" }
        },
        selected: {
    ...
    edgeStyles: {
        ...
        hovered: {
            TRANSMISSION: { color: "rgb(0, 140, 210)", weight: 4 },
            DISTRIBUTION: { color: "rgb(30, 220, 80)", weight: 3 },
