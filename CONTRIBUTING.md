...
Follow the steps outlined in [README](https://github.com/TudorOrban/WebFrontend/blob/main/README.md).
...
We are committed to providing a welcoming and inclusive experience for everyone. We expect all participants to adhere to our Code of Conduct. Please read [Code of Conduct](https://github.com/TudorOrban/WebFrontend/blob/main/CODE_OF_CONDUCT.md) to understand what behaviors will not be tolerated.
...
1. Go to the [Issues](https://github.com/TudorOrban/WebFrontend/issues) page.
